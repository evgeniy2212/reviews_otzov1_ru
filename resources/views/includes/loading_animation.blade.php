<div id="inTurnFadingTextG">
    ...
    <div id="inTurnFadingTextG_9" class="inTurnFadingTextG">f</div>
    <div id="inTurnFadingTextG_10" class="inTurnFadingTextG">i</div>
    <div id="inTurnFadingTextG_11" class="inTurnFadingTextG">l</div>
    <div id="inTurnFadingTextG_12" class="inTurnFadingTextG">e</div>
    <div id="inTurnFadingTextG_13" class="inTurnFadingTextG">s</div>
    <div id="inTurnFadingTextG_14" class="inTurnFadingTextG">.</div>
